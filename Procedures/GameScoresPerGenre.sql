...
DELIMITER //
DROP PROCEDURE IF EXISTS GameScoresPerGenre;
CREATE PROCEDURE GameScoresPerGenre(IN genre VARCHAR(20), IN year VARCHAR(5))
BEGIN
        ...
        FROM ALLSUBGAMES AG WHERE genres = genre and YEAR(date(AG.releaseDate)) > year 
